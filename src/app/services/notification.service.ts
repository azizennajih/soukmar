...
export interface AppNotification {
  id: string;
  userId: string;
  type: 'NEW_INQUIRY' | 'NEW_REPLY' | 'NEW_MESSAGE' | 'NEW_REVIEW' | 'SAVED_SEARCH_MATCH' | 'REPORT_RESOLVED' | 'LISTING_EXPIRING_SOON' | 'LISTING_EXPIRED' | 'PRICE_DROP' | 'ID_VERIFICATION_REVIEWED';
