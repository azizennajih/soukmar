export type Category =
  ...
  | 'BABY_KIDS' | 'PETS' | 'SPORTS_LEISURE' | 'LESSONS_COURSES';
...
// seller can always type something not on this list.
export const JOB_PROFESSION_CODES: string[] = [
  'DOCTOR', 'DENTIST', 'PHARMACIST', 'NURSE', 'PHYSIOTHERAPIST', 'OCCUPATIONAL_THERAPIST', 'MIDWIFE',
  'MEDICAL_ASSISTANT', 'PSYCHOLOGIST', 'PARAMEDIC', 'LAB_TECHNICIAN', 'OTHER_HEALTHCARE',

  'COMPUTER_SCIENTIST', 'SOFTWARE_DEVELOPER', 'WEB_DEVELOPER', 'APP_DEVELOPER', 'IT_SYSTEM_ADMIN',
  'NETWORK_ADMIN', 'CYBERSECURITY', 'DATA_SCIENTIST_AI', 'DATABASE_ADMIN', 'IT_SUPPORT', 'SAP_SPECIALIST',
  'DEVOPS_CLOUD', 'IT_PROJECT_MANAGER',

  'ELECTRICIAN', 'INSTALLER', 'HEATING_SANITARY', 'MECHANIC', 'AUTO_MECHATRONIC', 'LOCKSMITH', 'CARPENTER',
  'ROOF_CARPENTER', 'MASON', 'PAINTER', 'ROOFER', 'TILER', 'METAL_WORKER', 'PLANT_MECHANIC',
  'INDUSTRIAL_MECHANIC', 'MECHATRONICS_TECH', 'CNC_SPECIALIST',

  'CIVIL_ENGINEER', 'ARCHITECT', 'SITE_MANAGER', 'STRUCTURAL_ENGINEER', 'SURVEYING', 'CIVIL_WORKS',
  'BUILDING_CONSTRUCTION', 'ROAD_CONSTRUCTION', 'CONSTRUCTION_HELPER',

  'BUSINESS_CLERK', 'CASE_WORKER', 'ADMINISTRATION', 'RECEPTION', 'SECRETARIAT', 'ASSISTANT', 'HR',
  'ACCOUNTING', 'CONTROLLING', 'PURCHASING', 'QUALITY_MANAGEMENT',

  'BANKING', 'INSURANCE', 'TAX_ADVISOR', 'AUDITOR', 'FINANCIAL_ADVISOR', 'CONTROLLER', 'ACCOUNTANT',
  'REAL_ESTATE_FINANCE', 'MANAGEMENT_CONSULTING',

  'SALESPERSON', 'RETAIL', 'WHOLESALE', 'CASHIER', 'STORE_MANAGEMENT', 'FIELD_SALES', 'SALES_REP',
  'ECOMMERCE', 'CUSTOMER_ADVISOR',

  'TRUCK_DRIVER', 'BUS_DRIVER', 'TAXI_DRIVER', 'COURIER_DRIVER', 'WAREHOUSE_WORKER', 'ORDER_PICKER',
  'LOGISTICS', 'FREIGHT_FORWARDING', 'DISPATCHER', 'WAREHOUSE_MANAGEMENT',

  'COOK', 'KITCHEN_HELPER', 'WAITER', 'RESTAURANT_STAFF', 'BAKER', 'PASTRY_CHEF', 'HOTEL', 'FRONT_DESK',
  'HOUSEKEEPING',

  'TEACHER', 'EDUCATOR', 'PEDAGOGUE', 'PROFESSOR', 'LECTURER', 'TRAINER', 'RESEARCH', 'SCIENCE',

  'LAWYER', 'NOTARY', 'LEGAL_EXPERT', 'LEGAL_ASSISTANT', 'POLICE', 'FIRE_DEPARTMENT', 'SECURITY_SERVICE',
  'JUDICIARY',

  'PRODUCTION_WORKER', 'MACHINE_OPERATOR', 'PLANT_OPERATOR', 'QUALITY_CONTROL', 'PRODUCTION_TECHNICIAN',
  'WELDER', 'MANUFACTURING_GENERAL', 'FOOD_PRODUCTION',

  'FARMER', 'GARDENER', 'FORESTER', 'ANIMAL_CARETAKER', 'AGRICULTURAL_HELPER', 'ENVIRONMENTAL_TECH',
  'RECYCLING',

  'GRAPHIC_DESIGNER', 'WEB_DESIGNER', 'PHOTOGRAPHER', 'VIDEOGRAPHER', 'JOURNALIST', 'SOCIAL_MEDIA',
  'MARKETING', 'ADVERTISING', 'TRANSLATOR', 'INTERPRETER',

  'HAIRDRESSER', 'BEAUTICIAN', 'NAIL_DESIGNER', 'FOOT_CARE', 'MASSEUR', 'CLEANING_STAFF', 'HOUSEHOLD_HELP',

  'CHILDCARE', 'SOCIAL_WORKER', 'ELDERLY_CARE', 'CARE_WORKER', 'DISABILITY_SUPPORT', 'FAMILY_SUPPORT',

  'MECHANICAL_ENGINEERING', 'ELECTRICAL_ENGINEERING', 'INDUSTRIAL_ENGINEERING', 'CHEMISTRY', 'BIOLOGY',
  'PHYSICS',

  'FOOTBALL_COACH', 'SPORTS_TEACHER', 'FITNESS_TRAINER', 'SPORTS_MANAGEMENT', 'SPORTS_CLUB',
];
