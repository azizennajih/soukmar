...
export const JOB_PROFESSIONS_BY_SECTOR: Record<string, string[]> = {
  ...
  MANUFACTURING: ['PRODUCTION_WORKER', 'MACHINE_OPERATOR', 'PLANT_OPERATOR', 'QUALITY_CONTROL', 'PRODUCTION_TECHNICIAN', 'WELDER', 'MANUFACTURING_GENERAL', 'FOOD_PRODUCTION'],
  ...
  CARE_SOCIAL: ['CHILDCARE', 'SOCIAL_WORKER', 'ELDERLY_CARE', 'CARE_WORKER', 'DISABILITY_SUPPORT', 'FAMILY_SUPPORT'],
  ENGINEERING_SCIENCE: ['MECHANICAL_ENGINEERING', 'ELECTRICAL_ENGINEERING', 'INDUSTRIAL_ENGINEERING', 'CHEMISTRY', 'BIOLOGY', 'PHYSICS'],
  SPORTS: ['FOOTBALL_COACH', 'SPORTS_TEACHER', 'FITNESS_TRAINER', 'SPORTS_MANAGEMENT', 'SPORTS_CLUB'],
};

export const JOB_PROFESSION_CODES: string[] = Object.values(JOB_PROFESSIONS_BY_SECTOR).flat();
